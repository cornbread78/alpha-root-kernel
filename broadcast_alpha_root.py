...
def broadcast_block():
    print("==================================================")
    print(" ALPHA ROOT - BROADCASTING TRANSACTION")
    print("==================================================")
    
    file_path = "alpha_root_genesis_block.dat"
    ...
    # Extract transaction payload by skipping the 8-byte network message header (4 magic + 4 size)
