...
def main():
    print("==================================================")
    print("   ALPHA ROOT KERNEL - CONSENSUS TX BUILDER       ")
    ...
    try:
        ...
        if not unspents:
            ...
            print("[*] Note: Mainnet consensus broadcast requires a funded wallet UTXO to pay miner fees.")
            sys.exit(1)
