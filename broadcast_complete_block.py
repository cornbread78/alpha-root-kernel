...
def broadcast():
    print("==================================================")
    print(" BROADCASTING COMPLETE REVOLVING DOOR CONTAINER")
    print("==================================================")
    
    file_path = "complete_revolving_door_block.dat"
    ...
    # Extract transaction payload by skipping the 8-byte network message header
