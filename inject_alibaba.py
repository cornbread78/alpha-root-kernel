...
def inject_phrase():
    print("==================================================")
    print(" ALIBABA PHRASE INJECTION & HEX TRANSFORMATION")
    print("==================================================")
    
    phrase = "Ali Baba and Close Sesame"
    ...
    # Inject phrase into the 32-byte prev_txid slot (padded with zeros)
    prev_txid = phrase_bytes.ljust(32, b'\x00')
    
    # VOUT index (4 bytes)
    vout = bytes.fromhex("00000000")
    
    # scriptSig: length + ASCII data
    ...
    # scriptPubKey: Inject phrase into the public key zero-padding slots (64 bytes body + 0x04 prefix + op_checksig suffix)
    pubkey_body = phrase_bytes.ljust(64, b'\x00')
    ...
    output_filename = "alibaba_mutant_block.dat"
